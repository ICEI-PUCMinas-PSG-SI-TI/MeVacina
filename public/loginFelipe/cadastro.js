...
async function cadastroUsuario() {
    ...
    await cadUsuario(usuario);


    // Redireciona para a página de login
    window.location.href = "../Páginas MeVacina/home.html"
...
async function cadUsuario(usuario) {
    try {
        // Faz um GET para a entidade `vacinasRegistradas`
        const resp = await fetch(`${BASE_URL}/usuarios?email=${usuario.email}`, {
            method: "GET",
            headers: {
